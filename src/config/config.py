...
def base_model_config(dataset'KITTI'):
    ...
    cfg.NUM.CLASSES = len(cfg.CLASSES)
    ...
    cfg.CLS_LOSS_WEIGHT = np.array(
        [1/20.0, 1.0, 2.0, 3.0, 8.0, 10.0, 8.0, 2.0, 1.0]
    )
    ...
    #Probility to keep a node in dropout
    cfg.KEEP_PROB = 0.5
    ...
    # number of pie sectors of the field of view ? #TODO
    cfg.NUM_SECTOR = 90
    ...
    #reduce step size after this mang step
    ...
    cfg.LOAD_PRETRAINED_MODEL_PATH =''

    #print log to console in debug mode
    cfg.DEBUG_MODE = False

    #gradients with norm larger than this is going to be clipped.?#TODO
    ...
    # small value used in batch normalizetion to prevent dividing by 0.
